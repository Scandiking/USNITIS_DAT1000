...
-- "steg for steg" utvikling av skriptet
-- skript for "basisstruktur" AnsattPersonal2023
-- utvidet med skranker (legge på krav om null/not null)
-- utvidet med forretningsregler/valideringsregler
-- utvidet med masseoppdatering (være forsiktig)
